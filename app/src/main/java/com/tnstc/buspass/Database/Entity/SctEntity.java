...
public class SctEntity {
    ...
    public SctEntity(long sec, int card, int spare, String key, int opening, int closing, String month, String year, int total, int sctTotalAmount, String date) {
        this.sec = sec;
        this.card = card;
        this.spare = spare;
        this.key = key;
